...
.kbzLam{color:#3D3D3D;}/*!sc*/
.kbzLam svg{margin:0 6px 0 0;fill:#6D6D6D;}/*!sc*/
data-styled.g1281[id="CommonStyled__CheckedSynced-bpcmiq-3"]{content:"kbzLam,"}/*!sc*/
.fDuEeK .list{margin:8px 0 0;padding:0 0 0 18px;list-style:none;}/*!sc*/
.fDuEeK .list .ProjectUpdate__BulletedLi-sc-1wprn0e-1{position:relative;padding:0 0 0 13px;}/*!sc*/
.fDuEeK .list .ProjectUpdate__BulletedLi-sc-1wprn0e-1 .ProjectUpdate__StyledSVGIcon-sc-1wprn0e-0{position:absolute;left:0;top:4px;}/*!sc*/
.fDuEeK .list li{color:#6D6D6D;margin:0 0 3px;}/*!sc*/
.fDuEeK .list li > div{font-size:12px;margin:0 2px 0 0;}/*!sc*/
.fDuEeK .list li > div > svg{fill:#6D6D6D;}/*!sc*/
.fDuEeK .list li:last-child{margin:0;}/*!sc*/
.fDuEeK .active{border-top:1px solid #F2F2F2;margin:13px 0 0;padding:13px 0 0 16px;list-style:none;}/*!sc*/
.fDuEeK .active li{margin:0 0 13px;}/*!sc*/
.fDuEeK .count{color:#6D6D6D;padding:2px 0 0 32px;}/*!sc*/
data-styled.g1358[id="ProjectUpdate__Wrapper-sc-1wprn0e-2"]{content:"fDuEeK,"}/*!sc*/
...
<script>
	$(".Idjxi").on("click",function(event) {
		...
		<div class="style__Container-sc-7of8vt-0 gmYOwM">
			<div class="Page__PageComponent-sc-1l7nky8-0 jPogNc UserSettings__StyledPage-kz39zf-0 JLshK tbb">
				<div class="UserSettings__SettingTitle-kz39zf-1 RltXI">
					<div class="Container__ContainerComponent-sc-1ey2h1l-0 kUAclQ SubHeader-sc-1refh74-0 gEYrbQ">
						<span>설정</span>
					</div>
					<div class="Container__ContainerComponent-sc-1ey2h1l-0 kUAclQ">
						<div
							...
							<div class="TabContainer__TabWrapper-sc-1vfhfos-1 jmMXca">
								<span class="TabContainer__Tab-sc-1vfhfos-2 hauegL"><a
									...
									class="TabContainer__Tab-sc-1vfhfos-2 hauegL current"><a
				...
				<div class="Container__ContainerComponent-sc-1ey2h1l-0 kUAclQ StyledTBB__column2Wrapper-trchgn-2 CommonStyled__Wrapper-bpcmiq-0 gYkBev cwoqcI">
					<div class="container">
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">메시지</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="message">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="message2">취소</button>
							</div>
							<p class="CommonStyled__Empty-bpcmiq-2 hvbYIg message">새 메시지 알림을 이메일로 수신하지 않습니다.</p>
							<div class="CommonStyled__CheckedSynced-bpcmiq-3 kbzLam" id="message3">
								<div name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs baseline">
									<svg viewBox="0 0 48 48">
										<path fill-rule="evenodd" clip-rule="evenodd"
											d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path>
									</svg>
								</div>
								새 메시지 알림을 이메일로 수신합니다.
							</div>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp" id="message4">
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<label for="55067445-d90f-405e-b1f9-443f860d4ae3" class="Checkbox__Wrapper-sc-1j98t5d-1 eQAnah CommonStyled__CustomCheckbox-bpcmiq-4 eGUMu checkMessage">
										...
										<input id="55067445-d90f-405e-b1f9-443f860d4ae3" type="checkbox" name="m_message" style="display: none">새 메시지 알림을 이메일로 수신합니다.
									</label>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="message5">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 messageBtn" color="gray80">
									<span>저장</span>
								</button>
							</div>
						</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								$("#message4").hide();
								$("#message5").hide();
								if ( ${ authUser.m_message == 1 } ) {
									$("#checkmark").show();
									$("input[name=m_message]").prop("checked", true);
									$(".message").hide();
									$("#message3").show();
								} else {
									$("#checkmark").hide();
									$("input[name=m_message]").prop("checked", false);
									$(".message").show();
									$("#message3").hide();
								}
								...
								$(".checkMessage").on("change", function() {
									if ( $("input[name=m_message]").prop("checked") ) {
										$("input[name=m_message]").val(1);
										$("#checkmark").show();
									} else {
										$("input[name=m_message]").val(0); 
										$("#checkmark").hide();
									}
								});
								
								$(".messageBtn").on("click", function () {
									var params = "pname=10&param=" + $("input[name=m_message]").val();
									$.ajax({
						             	...
						             	success: function ( data, textStatus, jqXHR ){
						             		var value = $("input[name=m_message]").val();
						             		if ( value == "1" ) {
												$(".message").html("");
												$("#message3").show();
												...
												$(".message").html("새 메시지 알림을 이메일로 수신하지 않습니다.");
						...
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">프로젝트 업데이트</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="up">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="up2">취소</button>
							</div>
							<p class="CommonStyled__Empty-bpcmiq-2 hvbYIg up">프로젝트 업데이트 알림을 이메일로 수신하지 않습니다.</p>
							<div class="ProjectUpdate__Wrapper-sc-1wprn0e-2 fDuEeK" id="up3">
								<div class="CommonStyled__CheckedSynced-bpcmiq-3 kbzLam">
									<div name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs baseline">
										<svg viewBox="0 0 48 48">
											<path fill-rule="evenodd" clip-rule="evenodd"
												d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path>
									...
									프로젝트 업데이트 알림을 이메일로 수신합니다.
								</div>
							</div>
							<div class="ProjectUpdate__Wrapper-sc-1wprn0e-2 fDuEeK" id="up4">
								<label for="741211e4-dd25-46ae-84d7-30ce23d4ac37"
									class="Checkbox__Wrapper-sc-1j98t5d-1 eQAnah CommonStyled__CustomCheckbox-bpcmiq-4 eGUMu checkUp">
									<span class="Checkbox__Checked-sc-1j98t5d-0 dmGFJz" id="checkmark2">
										...
										</div></span><input id="741211e4-dd25-46ae-84d7-30ce23d4ac37"
									type="checkbox" name="m_up" style="display: none">프로젝트 업데이트 알림을 이메일로 수신합니다.</label>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="up5">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 upBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								if ( ${ authUser.m_up == 1 } ) {
									$("#checkmark2").show();
									$("input[name=m_up]").prop("checked", true);
									$(".up").hide();
									$("#up3").show();
								} else {
									$("#checkmark2").hide();
									$("input[name=m_up]").prop("checked", false);
									$(".up").show();
									$("#up3").hide();
								}
								...
								$(".checkUp").on("change", function() {
									if ( $("input[name=m_up]").prop("checked") ) {
										$("input[name=m_up]").val(1);
										$("#checkmark2").show();
									} else {
										$("input[name=m_up]").val(0); 
										$("#checkmark2").hide();
									}
								});
								
								$(".upBtn").on("click", function () {
									var params = "pname=11&param=" + $("input[name=m_up]").val();
									$.ajax({
						             	url: "/tumblbug/settings/settingsProfileSave.ajax" , 
						             	dataType: "json",
						             	data: params,
						             	...
						             	success: function ( data, textStatus, jqXHR ){
						             		...
						             		if ( value == "1" ) {
												...
												$(".up").html("프로젝트 업데이트 알림을 이메일로 수신하지 않습니다.");
						...
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">알림신청 프로젝트</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="pro">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="pro2">취소</button>
							</div>
							<p class="CommonStyled__Empty-bpcmiq-2 hvbYIg pro">알림신청한 프로젝트가 공개되었다는 알림을 이메일로 수신하지 않습니다.</p>
							<div class="CommonStyled__CheckedSynced-bpcmiq-3 kbzLam" id="pro3">
								<div name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs baseline">
									<svg viewBox="0 0 48 48">
										<path fill-rule="evenodd" clip-rule="evenodd"
											d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path>
							...
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp PrelaunchedProject__CustomFormRenderChildren-sc-10lme3v-0 kLssLO" id="pro4">
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<label for="b58e3edf-5a3e-4b5b-94af-6479af178ca9"
										class="Checkbox__Wrapper-sc-1j98t5d-1 eQAnah CommonStyled__CustomCheckbox-bpcmiq-4 eGUMu checkPro"><span
										class="Checkbox__Checked-sc-1j98t5d-0 dmGFJz" id="checkmark3"><div
												name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs">
												<svg viewBox="0 0 48 48">
													<path fill-rule="evenodd" clip-rule="evenodd"
														d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path></svg>
											</div></span><input id="b58e3edf-5a3e-4b5b-94af-6479af178ca9"
										type="checkbox" name="m_pro">알림신청한 프로젝트가 공개되었다는 알림을 이메일로
										수신합니다.</label>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="pro5">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 proBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								if ( ${ authUser.m_pro == 1 } ) {
									$("#checkmark3").show();
									$("input[name=m_pro]").prop("checked", true);
									$(".pro").hide();
									$("#pro3").show();
								} else {
									$("#checkmark3").hide();
									$("input[name=m_pro]").prop("checked", false);
									$(".pro").show();
									$("#pro3").hide();
								}
								...
								$(".checkPro").on("change", function() {
									if ( $("input[name=m_pro]").prop("checked") ) {
										$("input[name=m_pro]").val(1);
										$("#checkmark3").show();
									} else {
										$("input[name=m_pro]").val(0); 
										$("#checkmark3").hide();
									}
								});
								
								$(".proBtn").on("click", function () {
									var params = "pname=12&param=" + $("input[name=m_pro]").val();
									$.ajax({
						             	url: "/tumblbug/settings/settingsProfileSave.ajax" , 
						             	dataType: "json",
						             	data: params,
						             	...
						             	cache: false,
						             	success: function ( data, textStatus, jqXHR ){
						             		var value = $("input[name=m_pro]").val();
						             		if ( value == "1" ) {
												$(".pro").html("");
												$("#pro3").show();
												...
												$(".pro").html("알림신청한 프로젝트가 공개되었다는 알림을 이메일로 수신하지 않습니다.");
						...
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">좋아한 프로젝트</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="liked">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="liked2">취소</button>
							</div>
							<p class="CommonStyled__Empty-bpcmiq-2 hvbYIg liked">좋아한 프로젝트가 공개되었다는 알림을 이메일로 수신하지 않습니다.</p>
							<div class="CommonStyled__CheckedSynced-bpcmiq-3 kbzLam" id="liked3">
								<div name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs baseline">
									<svg viewBox="0 0 48 48">
										<path fill-rule="evenodd" clip-rule="evenodd"
											d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path>
								...
								좋아한 프로젝트의 마감일이 임박했다는 알림을 이메일로 수신합니다.
							</div>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp LikedProject__CustomFormRenderChildren-sc-1ddsrv2-0 jxVgim" id="liked4">
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<label for="f92c9614-41a5-4f38-ac3d-c9de94e89b15"
										class="Checkbox__Wrapper-sc-1j98t5d-1 eQAnah CommonStyled__CustomCheckbox-bpcmiq-4 eGUMu checkLiked"><span
										class="Checkbox__Checked-sc-1j98t5d-0 dmGFJz" id="checkmark4"><div
												name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs">
												<svg viewBox="0 0 48 48">
													<path fill-rule="evenodd" clip-rule="evenodd"
														d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path></svg>
											</div></span><input id="f92c9614-41a5-4f38-ac3d-c9de94e89b15"
										type="checkbox" name="m_liked">좋아한 프로젝트의 마감일이 임박했다는 알림을 이메일로
										수신합니다.</label>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="liked5">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 likedBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								$("#liked4").hide();
								$("#liked5").hide();
								if ( ${ authUser.m_liked == 1 } ) {
									$("#checkmark4").show();
									$("input[name=m_liked]").prop("checked", true);
									$(".liked").hide();
									$("#liked3").show();
								} else {
									$("#checkmark4").hide();
									$("input[name=m_liked]").prop("checked", false);
									$(".liked").show();
									$("#liked3").hide();
								}
								...
								$(".checkLiked").on("change", function() {
									if ( $("input[name=m_liked]").prop("checked") ) {
										$("input[name=m_liked]").val(1);
										$("#checkmark4").show();
									} else {
										$("input[name=m_liked]").val(0); 
										$("#checkmark4").hide();
									}
								});
								
								$(".likedBtn").on("click", function () {
									var params = "pname=13&param=" + $("input[name=m_liked]").val();
									$.ajax({
						             	url: "/tumblbug/settings/settingsProfileSave.ajax" , 
						             	dataType: "json",
						             	data: params,
						             	...
						             	cache: false,
						             	success: function ( data, textStatus, jqXHR ){
						             		var value = $("input[name=m_liked]").val();
						             		if ( value == "1" ) {
												$(".liked").html("");
												$("#liked3").show();
												...
												$(".liked").html("좋아한 프로젝트가 공개되었다는 알림을 이메일로 수신하지 않습니다.");
						...
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">팔로우</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="follow">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="follow2">취소</button>
							</div>
							<p class="CommonStyled__Empty-bpcmiq-2 hvbYIg follow">팔로우한 이용자의 프로젝트 공개 알림을 이메일로 수신하지 않습니다.</p>
							<div class="CommonStyled__CheckedSynced-bpcmiq-3 kbzLam" id="follow3">
								<div name="check"
								...
								팔로우한 사용자의 프로젝트 공개 알림을 이메일로 수신합니다.
							</div>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp Follow__CustomFormRenderChildren-vju1d0-0 clRhVM" id="follow4">
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<label for="73126fd1-e251-44a0-b785-8861d91297d9"
										class="Checkbox__Wrapper-sc-1j98t5d-1 eQAnah CommonStyled__CustomCheckbox-bpcmiq-4 eGUMu checkFollow"><span
										class="Checkbox__Checked-sc-1j98t5d-0 dmGFJz" id="checkmark5"><div
												name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs">
												<svg viewBox="0 0 48 48">
													<path fill-rule="evenodd" clip-rule="evenodd"
														d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path></svg>
											</div></span><input id="73126fd1-e251-44a0-b785-8861d91297d9"
										type="checkbox" name="m_follow">팔로우한 사용자의 프로젝트 공개 알림을 이메일로
										수신합니다.</label>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="follow5">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 followBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								$("#follow4").hide();
								$("#follow5").hide();
								if ( ${ authUser.m_follow == 1 } ) {
									$("#checkmark5").show();
									$("input[name=m_follow]").prop("checked", true);
									$(".follow").hide();
									$("#follow3").show();
								} else {
									$("#checkmark5").hide();
									$("input[name=m_follow]").prop("checked", false);
									$(".follow").show();
									$("#follow3").hide();
								}
								...
								$(".checkFollow").on("change", function() {
									if ( $("input[name=m_follow]").prop("checked") ) {
										$("input[name=m_follow]").val(1);
										$("#checkmark5").show();
									} else {
										$("input[name=m_follow]").val(0); 
										$("#checkmark5").hide();
									}
								});
								
								$(".followBtn").on("click", function () {
									var params = "pname=14&param=" + $("input[name=m_follow]").val();
									$.ajax({
						             	url: "/tumblbug/settings/settingsProfileSave.ajax" , 
						             	dataType: "json",
						             	data: params,
						             	...
						             	cache: false,
						             	success: function ( data, textStatus, jqXHR ){
						             		var value = $("input[name=m_follow]").val();
						             		if ( value == "1" ) {
												$(".follow").html("");
												$("#follow3").show();
												...
												$(".follow").html("팔로우한 이용자의 프로젝트 공개 알림을 이메일로 수신하지 않습니다.");
						...
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">마케팅 메일</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="mail">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="mail2">취소</button>
							</div>
							<p class="CommonStyled__Empty-bpcmiq-2 hvbYIg mail">텀블벅 신규 콘텐츠 및 프로젝트 추천 알림을 이메일로 수신하지 않습니다.</p>
							<div class="CommonStyled__CheckedSynced-bpcmiq-3 kbzLam" id="mail3">
								<div name="check"
									class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs baseline">
									<svg viewBox="0 0 48 48">
										<path fill-rule="evenodd" clip-rule="evenodd"
								...
								텀블벅 신규 콘텐츠 및 프로젝트 추천 알림을 이메일로 수신합니다.
							</div>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp NewsLetter__CustomFormRenderChildren-tyfh09-0 hXKuRi" id="mail4">
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<label for="784a0c64-cb61-4793-99dc-df0f09702234"
										class="Checkbox__Wrapper-sc-1j98t5d-1 eQAnah CommonStyled__CustomCheckbox-bpcmiq-4 eGUMu checkMail"><span
										class="Checkbox__Checked-sc-1j98t5d-0 dmGFJz" id="checkmark6"><div
												name="check" class="Icon__SVGICON-sc-1xkf9cp-0 ccxeYs">
												<svg viewBox="0 0 48 48">
													<path fill-rule="evenodd" clip-rule="evenodd"
														d="M41.6 8L18.9 30.8L6.2 19L2 23.5L19.1 39.4L46 12.4L41.6 8Z"></path></svg>
											</div></span><input id="784a0c64-cb61-4793-99dc-df0f09702234"
										type="checkbox" name="m_mk">텀블벅 신규 콘텐츠 및 프로젝트
										추천 알림을 이메일로 수신합니다.</label>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="mail5">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 mailBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								if ( ${ authUser.m_mk == 1 } ) {
									$("#checkmark6").show();
									$("input[name=m_mk]").prop("checked", true);
									$(".mail").hide();
									$("#mail3").show();
								} else {
									$("#checkmark6").hide();
									$("input[name=m_mk]").prop("checked", false);
									$(".mail").show();
									$("#mail3").hide();
								}
								...
								$(".checkMail").on("change", function() {
									if ( $("input[name=m_mk]").prop("checked") ) {
										$("input[name=m_mk]").val(1);
										$("#checkmark6").show();
									} else {
										$("input[name=m_mk]").val(0); 
										$("#checkmark6").hide();
									}
								});
								...
								$(".mailBtn").on("click", function () {
									...
									if ( document.querySelector("input[name=m_mk]").checked ) {
										alert(dateString + " 텀블벅 마케팅 메일 수신에 동의하셨습니다.");
										
										var params = "pname=15&param=" + $("input[name=m_mk]").val();
										$.ajax({
							             	url: "/tumblbug/settings/settingsProfileSave.ajax" , 
							             	dataType: "json",
							             	data: params,
							             	...
							             	success: function ( data, textStatus, jqXHR ){
							             		...
							             		if ( value == "1" ) {
													...
													$(".mail").html("텀블벅 신규 콘텐츠 및 프로젝트 추천 알림을 이메일로 수신하지 않습니다.");
										...
										var confirmFlag = confirm("수신을 거부하실 경우, 텀블벅에서 제공하는 새로운 프로젝트, 이벤트, 지원사업 등의 정보를 제공받을 수 없습니다. 계속 진행하시겠습니까?");
										if ( confirmFlag ) {
											alert(dateString + " 텀블벅 마케팅 메일 수신을 거부하셨습니다.");
					...
					<div class="CommonStyled__SettingPageDescBox-bpcmiq-1 cwYHpD">
						<p class="fnt-p1 tbb-clr-gray-80 fnt-st-bd">어떤 이메일로 알림을 받나요?</p>
						<div class="fnt-p3 tbb-clr-gray-60">
							회원님의 로그인 이메일 (
							<!-- -->
							${ authUser.m_email }
							<!-- -->
							) 로 알림 메일을 수신하게 됩니다. 변경을 원하실 경우 계정 설정 항목에서 이메일을 변경해주세요.
						</div>
					</div>
				</div>
			</div>
