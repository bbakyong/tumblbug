<%@page import="auth.service.LoginService"%>
...
.doqNeH{display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;height:32px;padding:0 16px;background:none;border:1px solid #e4e4e4;border-radius:60px;font-size:12px !important;line-height:20px !important;font-weight:500;font-family:'NotoSansKR','SF Pro Text','Segoe UI','Helvetica Neue',Arial,sans-serif !important;color:#3d3d3d;}/*!sc*/
.doqNeH:hover:enabled{background-color:#fcfcfc;}/*!sc*/
data-styled.g300[id="RoundOutlineButton-sc-1a0doq1-0"]{content:"doqNeH,"}/*!sc*/
...
.hBjDgK{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;margin:0;}/*!sc*/
data-styled.g302[id="SettingForm__FormHeader-sc-169upu5-1"]{content:"jzTvBl,hBjDgK,"}/*!sc*/
...
.cIhcRD{color:#FF5757;}/*!sc*/
.cIhcRD svg{margin:0 6px 0 0;fill:#FF5757;}/*!sc*/
.eYgKHf{color:#00C88E;}/*!sc*/
.eYgKHf svg{margin:0 6px 0 0;fill:#00C88E;}/*!sc*/
.kbzLam{color:#3D3D3D;}/*!sc*/
.kbzLam svg{margin:0 6px 0 0;fill:#6D6D6D;}/*!sc*/
data-styled.g1281[id="CommonStyled__CheckedSynced-bpcmiq-3"]{content:"cIhcRD,eYgKHf,kbzLam,"}/*!sc*/
.iDyRjU{overflow:hidden;min-height:100px;}/*!sc*/
.iDyRjU p{color:#3D3D3D;font-size:13px;line-height:20px;-webkit-letter-spacing:-0.015em;-moz-letter-spacing:-0.015em;-ms-letter-spacing:-0.015em;letter-spacing:-0.015em;}/*!sc*/
.iDyRjU a{color:#3D3D3D;-webkit-text-decoration:underline;text-decoration:underline;font-size:14px;line-height:24px;-webkit-letter-spacing:-0.015em;-moz-letter-spacing:-0.015em;-ms-letter-spacing:-0.015em;letter-spacing:-0.015em;}/*!sc*/
.iDyRjU a:hover{color:rgba(61,61,61,0.5);-webkit-text-decoration:none;text-decoration:none;}/*!sc*/
data-styled.g1285[id="CommonStyled__SecessionWrapper-bpcmiq-7"]{content:"iDyRjU,"}/*!sc*/
.eTufRw .StyledTBB__FormWrapper-trchgn-6{margin:30px 0 0;}/*!sc*/
.eTufRw .first{margin:0;}/*!sc*/
.eTufRw .update-pass .StyledTBB__FormContent-trchgn-5{margin-top:12px;margin-bottom:0;}/*!sc*/
.eTufRw .update-pass .StyledTBB__FormContent-trchgn-5:first-of-type{margin-top:0;}/*!sc*/
data-styled.g1307[id="Password__CustomSettingForm-sc-1j00clf-2"]{content:"eTufRw,"}/*!sc*/
.ePdLkc{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;width:100%;}/*!sc*/
data-styled.g1309[id="Leave__TitleWrapper-sc-1osegmn-0"]{content:"ePdLkc,"}/*!sc*/
.fZfsrx{font-size:16px;font-weight:bold;}/*!sc*/
data-styled.g1311[id="Leave__Title-sc-1osegmn-2"]{content:"fZfsrx,"}/*!sc*/
...
.eTufRw .StyledTBB__FormWrapper-trchgn-6 {
    margin: 30px 0px 0px;
}
...
.eTufRw .update-pass .StyledTBB__FormContent-trchgn-5 {
    margin-top: 12px;
    margin-bottom: 0px;
}
			...
			<div
				...
				<div class="Container__ContainerComponent-sc-1ey2h1l-0 kUAclQ StyledTBB__column2Wrapper-trchgn-2 CommonStyled__Wrapper-bpcmiq-0 gYkBev cwoqcI">
					<div class="container">
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">이메일</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="email">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="email2">취소</button>
							</div>
							<div class="email">${ authUser.m_email }</div>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp" id="email3">
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<span class="Input__InputWrapper-j7moqy-0 dXKaPI"><input
										...
										autocomplete="off" autocapitalize="off" name="m_email"
										class="Input__InnerInput-j7moqy-1 bfmNPl"
										value="${ authUser.m_email }"></span>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="email4">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 emailBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								$(".emailBtn").on("click", function () {
									var params = "pname=7&param=" + $("input[name=m_email]").val();
									$.ajax({
							            ...
							            success: function ( data, textStatus, jqXHR ){
							            	alert("이메일이 변경되어 로그아웃되었습니다. 변경된 이메일로 다시 로그인해주세요");
							            	
							            	sessionStorage.clear();
							        		location.href = "/tumblbug/login.do"; 
							             },
						...
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF Password__CustomSettingForm-sc-1j00clf-2 eTufRw forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 hBjDgK fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">비밀번호</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="pw">변경</button>
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="pw2">취소</button>
							</div>
							<p class="CommonStyled__Empty-bpcmiq-2 hvbYIg"></p>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp Password__StyledFormRenderChildren-sc-1j00clf-0 fEdLjl first" id="pw3">
								<div class="StyledTBB__FormLabel-trchgn-4 keSzYC form-input-label">현재 비밀번호</div>
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<span class="Input__InputWrapper-j7moqy-0 dXKaPI"><input
										type="password" inputmode="password" placeholder="현재 비밀번호"
										autocomplete="off" autocapitalize="off" name="currentPW"
										class="Input__InnerInput-j7moqy-1 jGEGrw"></span>
								</div>
							</div>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp Password__StyledFormRenderChildren-sc-1j00clf-0 fEdLjl update-pass" id="pw4">
								<div class="StyledTBB__FormLabel-trchgn-4 keSzYC form-input-label">변경할 비밀번호</div>
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<span class="Input__InputWrapper-j7moqy-0 dXKaPI"><input
										type="password" inputmode="password" placeholder="변경할 비밀번호"
										autocomplete="off" autocapitalize="off" name="m_pw"
										class="Input__InnerInput-j7moqy-1 jGEGrw"></span>
								</div>
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<span class="Input__InputWrapper-j7moqy-0 dXKaPI"><input
										type="password" inputmode="password" placeholder="변경할 비밀번호 확인"
										autocomplete="off" autocapitalize="off" name="confirmM_pw"
										class="Input__InnerInput-j7moqy-1 jGEGrw"></span>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="pw5">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 pwBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								$(".pwBtn").on("click", function () {
									var params = "pname=8&currentPW=" + $("input[name=currentPW]").val() + "&m_pw=" + $("input[name=m_pw]").val() + "&confirmM_pw=" + $("input[name=confirmM_pw]").val();
									$.ajax({
							    		url: "/tumblbug/settings/settingsProfileSave.ajax" , 
							            dataType: "json",
							            data: params,
							            ...
							            cache: false,
							            success: function ( data, textStatus, jqXHR ){
							            	alert("비밀번호가 변경되어 로그아웃되었습니다. 변경된 비밀번호로 다시 로그인해주세요");
							            	
							            	sessionStorage.clear();
							        		location.href = "/tumblbug/login.do";
							             },
							             error:function ( xhr, status, error ) {
							             	$(".cpnm").html(xhr.status + ': ' + xhr.statusText);
							             }
									});
								});
							});
						...
						<div class="SettingForm__Wrapper-sc-169upu5-0 jKMMYF forms">
							<div class="SettingForm__FormHeader-sc-169upu5-1 jzTvBl fnt-p1">
								<p class="SettingForm__FormTitle-sc-169upu5-2 jKbeSH">연락처</p>
								<button class="RoundButton-gkjnnx-0 cICyND" id="tel">
									<c:choose>
										<c:when test="${ not empty authUser.m_tel }">
											변경
										</c:when>
										<c:otherwise>
											등록
								...
								<button class="RoundOutlineButton-sc-1a0doq1-0 doqNeH" id="tel2">취소</button>
							</div>
							<p class="tel">
								<c:choose>
									<c:when test="${ not empty authUser.m_tel }">
										${ authUser.m_tel }
										<script type="text/javascript">
											$("p.tel").removeClass("CommonStyled__Empty-bpcmiq-2 hvbYIg");
										</script>
									</c:when>
									<c:otherwise>
										등록된 연락처가 없습니다.
										<script type="text/javascript">
											$("p.tel").addClass("CommonStyled__Empty-bpcmiq-2 hvbYIg");
										</script>
									</c:otherwise>
								</c:choose>
							</p>
							<div class="StyledTBB__FormWrapper-trchgn-6 hCtMzp setting-form" id="tel3">
								<div class="StyledTBB__FormContent-trchgn-5 iBKDvR form-input-wrapper">
									<span class="Input__InputWrapper-j7moqy-0 dXKaPI"><input
										type="text" inputmode="numeric" pattern="[0-9]*"
										placeholder="휴대폰 번호를 입력해주세요." maxlength="20"
										autocomplete="off" autocapitalize="off" name="m_tel"
										class="Input__InnerInput-j7moqy-1 bfmNPl" value="${ authUser.m_tel }"></span>
								</div>
							</div>
							<div class="SettingForm__SubmitButton-sc-169upu5-3 iRzALa" id="tel4">
								<button class="SolidButton__Button-sc-1gsinzz-0 guJEfD fnt-p1 telBtn"
									color="gray80">
									<span>저장</span>
								</button>
							</div>
						...
						<script type="text/javascript">
							$(function() {
								...
								$(".telBtn").on("click", function () {
									var params = "pname=9&param=" + $("input[name=m_tel]").val();
									$.ajax({
							    		url: "/tumblbug/settings/settingsProfileSave.ajax" , 
							            dataType: "json",
							            data: params,
							            ...
							            cache: false,
							            success: function ( data, textStatus, jqXHR ){
							            	var value = $("input[name=m_tel]").val();
							             	$(".tel").html( value );
							             	$("#tel").html("변경");
							             	$("p.tel").removeClass("CommonStyled__Empty-bpcmiq-2 hvbYIg");
							             	
							             	if ( !value ) {
						             			$(".tel").html( "등록된 연락처가 없습니다." );
						             			$("#tel").html("등록");
						             			$("p.tel").addClass("CommonStyled__Empty-bpcmiq-2 hvbYIg");
											}
						...
						<div class="CommonStyled__SecessionWrapper-bpcmiq-7 iDyRjU forms">
							<div class="Leave__TitleWrapper-sc-1osegmn-0 ePdLkc">
								<div class="Leave__Title-sc-1osegmn-2 fZfsrx">회원탈퇴</div>
								<button class="Leave__LeaveTextButton-sc-1osegmn-1 iGTuIW" onclick="location.href='/tumblbug/publicWeb/leaveGuide.jsp'">탈퇴</button>
							</div>
						</div>
					</div>
					...
					<div class="CommonStyled__SettingPageDescBox-bpcmiq-1 cwYHpD">
						<p class="fnt-p1 tbb-clr-gray-80 fnt-st-bd">이메일과 연락처는 어디에
							쓰이나요?</p>
						<div class="fnt-p3 tbb-clr-gray-60">
							이메일과 연락처로 프로젝트, 후원 및 결제 관련 알림을 드립니다. 배송 받는 분의 연락처는 개별 후원내역에서
							변경해주세요.
							<!-- -->
							<span color="sub0180"
